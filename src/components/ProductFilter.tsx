  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        ${isOpen ? "fixed inset-0 z-40 p-6 overflow-y-auto bg-white" : "hidden"}
      `}
      >
        {/* Mobile Header */}
        ...
        <div className="space-y-6 md:pb-0 pb-20">
          ...
          <div className="mb-6">
            <h3 className="text-gray-800 font-semibold text-sm uppercase tracking-wider mb-3">
              Availability
            </h3>
          ...
          <div className="mb-6">
            ...
            <div className="space-y-3">
              ...
              {(["xs", "s", "m", "l", "xl", "xxl"] as ProductSize[]).map(
                (size) => (
                  <label
                    key={size}
