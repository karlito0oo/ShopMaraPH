    ...
    <footer className="bg-gray-100 pt-12 pb-8 font-body font-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {/* Brand and About */}
          <div>
            <h3 className="font-header font-light text-lg mb-4">SHOPMARA PH</h3>
          ...
          {/* Shop Links */}
          <div>
            <h3 className="font-header font-light text-lg mb-4">Shop</h3>
            <ul className="space-y-2">
              ...
              <li><Link to="/sale" className="text-gray-600 hover:text-black text-sm">Sale</Link></li>
            </ul>
          </div>

          {/* Company Links */}
          <div>
            <h3 className="font-header font-light text-lg mb-4">Company</h3>
            <ul className="space-y-2">
