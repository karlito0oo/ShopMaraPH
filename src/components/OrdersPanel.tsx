    ...
    <>
      ...
      {loading ? (
        ...
        <div className="grid md:grid-cols-12 gap-6">
          ...
          <div
            className={`${
              selectedOrder && mobileView ? "hidden" : ""
            } md:col-span-5 lg:col-span-4 bg-white shadow rounded overflow-auto`}
          ...
          <div
            className={`${
              !selectedOrder && mobileView ? "hidden" : ""
            } md:col-span-7 lg:col-span-8 bg-white shadow rounded overflow-auto`}
            style={{ maxHeight: "calc(100vh - 200px)" }}
          >
            {selectedOrder ? (
              <div className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  <div>
                    ...
                    <p className="mb-1">
                      ...
                      {selectedOrder.address_line1}, {selectedOrder.barangay},{" "}
                  ...
                  <div>
                    ...
                    <p className="mb-1">
                      ...
                      {parseFloat(
                        selectedOrder.total_amount.toString()
                      ).toFixed(2)}
                    </p>
                    <p className="mb-1">
                      <span className="font-medium">Shipping Fee:</span> ₱
                      {parseFloat(
                        (selectedOrder.shipping_fee || 0).toString()
                      ).toFixed(2)}
                    </p>
                    <p className="mb-1">
                      ...
                      {(
                        ...
                        parseFloat((selectedOrder.shipping_fee || 0).toString())
                      ).toFixed(2)}
                    </p>
                ...
                {selectedOrder.payment_proof && (
                  <div className="mb-6">
                    ...
                    <div className="w-full max-w-sm border border-gray-200 rounded overflow-hidden">
                      <img
                        src={`${API_CONFIG.BASE_URL.replace(
                          "api.",
                          ""
                        )}/storage/${selectedOrder.payment_proof}`}
                        alt="Payment Proof"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                      <div>
                        ...
                        <select
                          ...
                          value={updateStatus}
                          onChange={(e) =>
                            onUpdateStatus && onUpdateStatus(e.target.value)
                          }
                        >
