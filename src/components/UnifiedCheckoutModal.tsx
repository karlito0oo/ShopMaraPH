...
const UnifiedCheckoutModal: React.FC<UnifiedCheckoutModalProps> = ({
  ...
  const [formMode, setFormMode] = useState<FormMode>(
    isAuthenticated ? "checkout" : "initial"
  );
  ...
  // Helper function to get barangays by city name
  const getBarangaysByCityName = async (
    cityName: string,
    provinceName: string
  ) => {
    try {
              ...
              {!isAuthenticated && formMode === "initial" && (
                <>
                  ...
                  <p className="text-gray-600 mb-6">
                    Would you like to save your cart by creating an account, or
                    continue as a guest?
                  </p>
                      ...
                      <div className="flex items-center">
                        ...
                        <div
                          className={`flex-1 h-1 mx-2 ${
                            currentStep >= 2 ? "bg-[#ad688f]" : "bg-gray-200"
                          }`}
                        ></div>
                        <div
                          className={`flex items-center justify-center h-8 w-8 rounded-full ${
                        ...
                        <div
                          className={`flex-1 h-1 mx-2 ${
                            currentStep >= 3 ? "bg-[#ad688f]" : "bg-gray-200"
                          }`}
                        ></div>
                        <div
                          className={`flex items-center justify-center h-8 w-8 rounded-full ${
                            ...
                            <div className="mt-4">
                              <div
                                ...
                                dangerouslySetInnerHTML={{
                                  __html: settings.paymentOptionsDescription,
                                }}
                              />
                            </div>
                          )}
                        ...
                        settings.whatHappensAfterPayment && (
                          <div className="bg-yellow-50 p-4 rounded border border-yellow-200">
                            <div
                              className="prose prose-sm max-w-none"
                              dangerouslySetInnerHTML={{
                                __html: settings.whatHappensAfterPayment,
                              }}
                            />
                          </div>
                        )}
